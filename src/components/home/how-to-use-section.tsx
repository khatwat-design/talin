...
export default function HowToUseSection() {
  const steps = [
    { num: "01", title: "دلكي الفروة", desc: "ضعي كمية صغيرة من الزيت على أطراف الأصابع ودلكي فروة الرأس بلطف لمدة 3-5 دقائق" },
    { num: "02", title: "وزّعيه على الشعر", desc: "مدي الزيت من الجذور إلى الأطراف مع التأكد من تغطية جميع الخصلات" },
    { num: "03", title: "اتركيه ليلاً", desc: "اتركي الزيت على شعرك طوال الليل للحصول على أفضل النتائج" },
    { num: "04", title: "اغسلي شعرك", desc: "اغسلي شعرك بالشامبو كالمعتاد في الصباح وتمتعي بالنتيجة" },
  ];
