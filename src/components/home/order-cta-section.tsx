      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <a
            ...
            className="mt-8 inline-flex items-center gap-2.5 rounded-full bg-[var(--color-primary)] px-8 py-4 text-sm font-bold text-white shadow-[0_4px_24px_-4px_rgba(184,134,11,0.4)] transition-all hover:scale-[1.02] hover:shadow-[0_8px_32px_-4px_rgba(184,134,11,0.5)]"
          >
