        ...
        <div className="mx-auto mt-10 grid max-w-lg grid-cols-1 gap-4 sm:grid-cols-2">
          {whatsappNumber ? (
            ...
            >
              ...
              <div>
                <h3 className="text-sm font-bold text-[var(--color-foreground)]" style={{ fontFamily: "var(--font-tajawal)" }}>واتساب</h3>
                <p className="mt-0.5 text-xs text-[var(--color-muted)]">تواصل معنا مباشرة</p>
              </div>
            </a>
          ) : null}
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-3 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface-warm)] p-5 transition hover:border-[var(--color-primary)] hover:shadow-md sm:p-6"
          >
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[var(--color-primary)]/10 text-[var(--color-primary)] transition group-hover:scale-110">
            ...
            <div>
              <h3 className="text-sm font-bold text-[var(--color-foreground)]" style={{ fontFamily: "var(--font-tajawal)" }}>إنستغرام</h3>
              <p className="mt-0.5 text-xs text-[var(--color-muted)]">تابعنا للمزيد</p>
            </div>
          </a>
        </div>
      </div>
