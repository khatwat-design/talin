    ...
    <footer className="border-t border-[var(--color-border)] bg-white">
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <div className="text-center sm:text-left">
          ...
          {/* Social — bigger touch targets on mobile */}
          <div className="mt-5 flex items-center justify-center gap-3 sm:justify-start">
            {whatsappLink !== "#" ? (
              <a
                ...
                className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#25D366]/10 text-[#25D366] transition hover:bg-[#25D366]/20"
              >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex h-11 w-11 items-center justify-center rounded-xl bg-[var(--color-primary)]/10 text-[var(--color-primary)] transition hover:bg-[var(--color-primary)]/20"
            >
        ...
        <div className="mt-8 grid grid-cols-2 gap-6 border-t border-[var(--color-border)] pt-8 sm:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              <li>
                <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-[var(--color-muted)] transition hover:text-[#25D366]">
                  واتساب
                </a>
              </li>
              <li>
